...
import (
	...
	"github.com/eron97/testes-mocks.git/teste6/models"
	_ "github.com/go-sql-driver/mysql"
)

type Database interface {
	InitDB() (*sql.DB, error)
	GetAllUsers(db *sql.DB) ([]models.User, error)
}
...
func (db *MySQLDatabase) GetAllUsers(connection *sql.DB) ([]models.User, error) {
